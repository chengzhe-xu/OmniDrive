...
class StreamPETRHeadv2(AnchorFreeHead):
    ...
    def __init__(self,
        ...
        if class_weight is not None and (self.__class__ is StreamPETRHeadv2):
        ...
        super(StreamPETRHeadv2, self).__init__(num_classes, in_channels, init_cfg = init_cfg)
    ...
    def _init_layers(self):
        ...
        #     nn.Linear(256, self.embed_dims*4),
        #     nn.ReLU(),
    ...
    def _load_from_state_dict(self, state_dict, prefix, local_metadata, strict,
        ...
        if (version is None or version < 2) and self.__class__ is StreamPETRHeadv2:
            convert_dict = {
    ...
    def forward(self, img_metas, pos_embed, **data):
        ...
        if self.output_dims is not None:
            ...
            # can_bus_embed = self.can_bus_embed(pos2posemb1d(can_bus_input[..., :1]))
